    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-3 text-sm text-gray-400">
              Bringing communities together through shared bulk orders and convenient neighborhood deliveries.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/communities" className="text-gray-400 hover:text-white">Communities</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Stay updated with our latest features and community news.</p>
            <form className="flex">
              <input 
                type="email" 
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} LastMile. All rights reserved.</p>
